...
function generateShowcase(): string {
  return `<!DOCTYPE html>
<html lang="en">
  ...
  <div class="max-w-7xl mx-auto px-4 py-12">
    ...
    <div class="text-center mb-16">
      ...
      <div class="flex justify-center gap-4 mt-6">
        ${Button({ text: "View on JSR", href: "https://jsr.io/@aspect/lum-ui", variant: "primary", icon: "externalLink" })}
    ...
    <div class="mt-16 pt-8 border-t border-white/5 text-center">
      <p class="text-zinc-500 text-sm">
        ...
        <a href="https://jsr.io/@aspect/lum-ui" class="text-[#FF4D8D] hover:underline">View on JSR</a>
      </p>
    </div>
